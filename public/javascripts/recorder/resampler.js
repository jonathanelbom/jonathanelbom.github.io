...
Resampler.prototype.resample = function( buffer, channel ) {
  ...
  //console.log('this.resampledRate:'+this.resampledRate+', this.originalSampleRate:'+this.originalSampleRate+', buffer.length:'+buffer.length+', resampledBufferLength:'+resampledBufferLength);
